...
do -- ACF global vars
	...
	ACF.LengthToTime       = 0.11 -- Conversion of projectile length to time -- Emulating the added difficulty of manipulating a longer projectile
	...
	ACF.FuelRate           = 12 -- Multiplier for fuel usage, 1.0 is approx real world
	...
	ACF.CrewFallbackCoef 	= 0.5	-- Minimum possible efficiency
	ACF.CrewCommanderCoef 	= 0.2	-- Portion of a crew's efficiency the commander provides
	ACF.CrewSelfCoef 	= 1	-- Portion of a crew's efficiency they provide
